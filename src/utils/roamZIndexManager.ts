...
class RoamZIndexManager {
  private static instance: RoamZIndexManager;
  private styleElement: HTMLStyleElement | null = null;
  private readonly STYLE_ID = 'roam-memo-zindex-fix';

  private constructor() {}

  public static getInstance(): RoamZIndexManager {
...
// 导出单例实例
export const roamZIndexManager = RoamZIndexManager.getInstance();
